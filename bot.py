...
async def start(bot, cmd):
	...
	if usr_cmd == "/start":
			...
			try:
				...
				if user.status == "kicked":
					await bot.send_message(
						...
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Kannada_HD_FilmsRequest).",
						parse_mode="markdown",
				...
				await bot.send_message(
					chat_id=cmd.from_user.id,
					text="Something went Wrong. Contact my [Support Group](https://t.me/Kannada_HD_FilmsRequest).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						...
						InlineKeyboardButton("Bots Channel", url="https://t.me/Kannada_Film_HD")
					],
					[
		...
		try:
			...
			await send_stored_file.reply_text(f"**Join @Kannada_HD_FilmRequest!__", disable_web_page_preview=True, quote=True)
